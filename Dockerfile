...
ARG VITE_OAUTH_BASE=/oauth
ARG VITE_OAUTH_CLIENT_ID=fileserver-web
ARG VITE_OAUTH_SCOPE="openid profile email offline_access"
ARG VITE_APP_BASE=./
ENV VITE_API_BASE=${VITE_API_BASE}
ENV VITE_OAUTH_BASE=${VITE_OAUTH_BASE}
